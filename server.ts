...
async function startServer() {
  ...
  // API responses are JSON and React escapes rendered text. Route validators reject malformed input;
  // do not mutate request payloads with deprecated global XSS middleware.
